...
def arg_parser(ident: str = None, port: int = 8020):
    ...
    "ident", if specified, refers to one of the standard demo personas - student, uca, company or performance.
    """
    ...
    if (not ident) or (ident != "student"):
        parser.add_argument(
            ...
            action="store_true",
            help=(
                "Reuse connections by using uca public key in the invite. "
